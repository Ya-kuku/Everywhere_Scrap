...
def make(text,idx, png_name1, png_name2):
    ...
    try:
        if not os.path.exists("../frontend/src/assets/img/itscience/"+str(png_name1)):
            os.makedirs("../frontend/src/assets/img/itscience/"+str(png_name1))
    except:
        pass
    
    try:
        if not os.path.exists("../frontend/src/assets/img/itscience/"+str(png_name1)+"/"+str(png_name2)):
            os.makedirs("../frontend/src/assets/img/itscience/"+str(png_name1)+"/"+str(png_name2))
    except:
        pass
    ...
    wc = stylecloud.gen_stylecloud(text=text,
                                    ...
                                    # gradient="horizontal",
                                    output_name="../frontend/src/assets/img/itscience/"+str(png_name1)+"/"+str(png_name2)+"/"+str(idx)+".png")
